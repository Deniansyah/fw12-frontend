                    ...
                    <div className="flex flex-col pl-14 py-10 h-screen">
                        ...
                        <div className="flex gap-5">
                            <div className="w-14 flex flex-col gap-6">
                                <div className="flex justify-center items-center font-bold text-violet-800 border-2 border-white bg-white rounded-full py-3.5 px4 after:content-[''] after:border-2 after:border-r after:border-white after:h-7 after:absolute relative after:right-6 after:top-[52px]">1</div>
                                ...
                                <div className="flex justify-center items-center font-bold text-white border-2 border-white rounded-full py-3.5 px4 after:content-[''] after:border-2 after:border-r after:border-white after:h-7 after:absolute relative after:right-6 after:top-[52px]">3</div>
