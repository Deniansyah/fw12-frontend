            ...
            <div className="flex items-center my-3">
                ...
                <div className="flex justify-center items-center gap-5">
                    <div className="group cursor-pointer flex items-center px-3 rounded-md py-1">
                        <Icon.Search />
                        <input className="py-1 px-3 hidden group-hover:block outline-none" type="text" placeholder="Search Movie Name ..." />
                    </div>
                    <div className="group relative cursor-pointer">
                        <img className="w-[46px]" src={require('../assets/images/home-profil.png')} alt="profil foto" />
                        <div className="flex flex-col gap-1 py-3 px-5  w-28 rounded bg-white absolute right-0 top-14 shadow-lg hidden group-hover:flex">
